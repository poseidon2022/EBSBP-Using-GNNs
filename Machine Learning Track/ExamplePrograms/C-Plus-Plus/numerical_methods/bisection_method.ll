; ModuleID = './numerical_methods/bisection_method.cpp'
source_filename = "./numerical_methods/bisection_method.cpp"
...
define internal noundef double @_ZL2eqd(double noundef %0) #5 {
  %2 = alloca double, align 8
...
define linkonce_odr dso_local noundef i32 @_Z3sgnIdEiT_(double noundef %0) #6 comdat {
  %2 = alloca double, align 8
  store double %0, ptr %2, align 8
  %3 = load double, ptr %2, align 8
