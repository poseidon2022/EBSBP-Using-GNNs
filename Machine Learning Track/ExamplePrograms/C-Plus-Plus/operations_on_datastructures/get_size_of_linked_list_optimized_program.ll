; ModuleID = './get_size_of_linked_list.cpp'
source_filename = "./get_size_of_linked_list.cpp"
...
define dso_local noundef i32 @_Z7getSizeP4Node(ptr noundef %0) #4 !prof !35 {
...
; Function Attrs: mustprogress noinline optnone uwtable
define dso_local void @_Z10deleteListP4Node(ptr noundef %0) #4 !prof !37 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load ptr, ptr %2, align 8
  %4 = icmp ne ptr %3, null
  br i1 %4, label %5, label %13, !prof !38
...
define dso_local noundef i32 @main() #6 personality ptr @__gxx_personality_v0 !prof !39 {
...
12:                                               ; preds = %24, %10
  ...
  br i1 %14, label %15, label %35, !prof !40
...
define linkonce_odr dso_local void @_ZN4NodeC2EiPS_(ptr noundef nonnull align 8 dereferenceable(16) %0, i32 noundef %1, ptr noundef %2) unnamed_addr #8 comdat align 2 !prof !43 {
...
!16 = !{i32 300000, i64 13, i32 2}
!17 = !{i32 400000, i64 13, i32 2}
!18 = !{i32 500000, i64 11, i32 4}
!19 = !{i32 600000, i64 11, i32 4}
!20 = !{i32 700000, i64 11, i32 4}
!21 = !{i32 800000, i64 11, i32 4}
!22 = !{i32 900000, i64 9, i32 5}
!23 = !{i32 950000, i64 9, i32 5}
!24 = !{i32 990000, i64 3, i32 6}
!25 = !{i32 999000, i64 3, i32 6}
!26 = !{i32 999900, i64 3, i32 6}
!27 = !{i32 999990, i64 3, i32 6}
!28 = !{i32 999999, i64 3, i32 6}
...
!35 = !{!"function_entry_count", i64 14}
!36 = !{!"branch_weights", i32 4, i32 12}
!37 = !{!"function_entry_count", i64 13}
!38 = !{!"branch_weights", i32 12, i32 3}
!39 = !{!"function_entry_count", i64 1}
!40 = !{!"branch_weights", i32 10, i32 2}
!41 = distinct !{!41, !42}
