; ModuleID = './median_search2.cpp'
source_filename = "./median_search2.cpp"
...
@.str.1 = private unnamed_addr constant [21 x i8] c"./median_search2.cpp\00", align 1
...
define dso_local noundef ptr @_ZN6search14median_search210middleNodeEP8ListNode(ptr noundef %0) #4 !prof !35 {
...
11:                                               ; preds = %25, %9
  ...
  br i1 %15, label %16, label %23, !prof !37
...
23:                                               ; preds = %16, %11
  ...
  br i1 %24, label %25, label %34, !prof !38
...
define dso_local void @_ZN6search14median_search29deleteAllEPK8ListNode(ptr noundef %0) #5 !prof !42 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load ptr, ptr %2, align 8
  %4 = icmp ne ptr %3, null
  br i1 %4, label %5, label %13, !prof !43
...
; Function Attrs: mustprogress noinline optnone uwtable
define internal void @_ZL4testv() #5 !prof !44 !PGOFuncName !45 {
...
15:                                               ; preds = %27, %0
  ...
  br i1 %17, label %18, label %30, !prof !46
...
49:                                               ; preds = %61, %42
  ...
  br i1 %51, label %52, label %64, !prof !37
...
define linkonce_odr dso_local void @_ZN8ListNodeC2Ev(ptr noundef nonnull align 8 dereferenceable(16) %0) unnamed_addr #9 comdat align 2 !prof !50 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load ptr, ptr %2, align 8
...
!14 = !{i32 100000, i64 13, i32 1}
!15 = !{i32 200000, i64 13, i32 1}
!16 = !{i32 300000, i64 11, i32 3}
!17 = !{i32 400000, i64 11, i32 3}
!18 = !{i32 500000, i64 11, i32 3}
!19 = !{i32 600000, i64 5, i32 5}
!20 = !{i32 700000, i64 5, i32 5}
!21 = !{i32 800000, i64 4, i32 8}
!22 = !{i32 900000, i64 4, i32 8}
!23 = !{i32 950000, i64 1, i32 14}
...
!37 = !{!"branch_weights", i32 6, i32 2}
!38 = !{!"branch_weights", i32 5, i32 3}
!39 = distinct !{!39, !40}
!40 = !{!"llvm.loop.mustprogress"}
!41 = !{!"branch_weights", i32 2, i32 2}
!42 = !{!"function_entry_count", i64 13}
!43 = !{!"branch_weights", i32 12, i32 3}
!44 = !{!"function_entry_count", i64 1}
!45 = !{!"median_search2.cpp:_ZL4testv"}
!46 = !{!"branch_weights", i32 5, i32 2}
!47 = distinct !{!47, !40}
!48 = !{!"branch_weights", i32 2, i32 1}
!49 = distinct !{!49, !40}
!50 = !{!"function_entry_count", i64 11}
