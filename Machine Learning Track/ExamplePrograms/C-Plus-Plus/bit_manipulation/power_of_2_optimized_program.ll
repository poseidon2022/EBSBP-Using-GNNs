; ModuleID = './power_of_2.cpp'
source_filename = "./power_of_2.cpp"
...
@.str.1 = private unnamed_addr constant [17 x i8] c"./power_of_2.cpp\00", align 1
...
define dso_local noundef zeroext i1 @_ZN16bit_manipulation12isPowerOfTwoEl(i64 noundef %0) #4 !prof !35 {
  %2 = alloca i64, align 8
  store i64 %0, ptr %2, align 8
  %3 = load i64, ptr %2, align 8
  %4 = icmp sgt i64 %3, 0
  br i1 %4, label %5, label %12, !prof !36
...
42:                                               ; preds = %41, %39
  ...
  %45 = icmp eq i32 %44, 0
  br i1 %45, label %46, label %47, !prof !39
...
49:                                               ; preds = %48, %46
  ...
  %52 = icmp eq i32 %51, 1
  br i1 %52, label %53, label %54, !prof !39
