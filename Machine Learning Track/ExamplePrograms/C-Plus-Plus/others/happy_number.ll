; ModuleID = './others/happy_number.cpp'
source_filename = "./others/happy_number.cpp"
...
@.str.1 = private unnamed_addr constant [19 x i8] c" is a happy number\00", align 1
@.str.2 = private unnamed_addr constant [23 x i8] c" is not a happy number\00", align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_happy_number.cpp, ptr null }]
...
define dso_local noundef i32 @main() #4 {
  ...
  %6 = call noundef zeroext i1 @_Z8is_happyIiEbT_(i32 noundef %5)
...
define linkonce_odr dso_local noundef zeroext i1 @_Z8is_happyIiEbT_(i32 noundef %0) #5 comdat {
  %2 = alloca i32, align 4
...
22:                                               ; preds = %5
  ...
  %26 = select i1 %24, i1 true, i1 false
  ret i1 %26
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_happy_number.cpp() #0 section ".text.startup" {
