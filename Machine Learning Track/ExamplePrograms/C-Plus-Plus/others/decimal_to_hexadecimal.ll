; ModuleID = './others/decimal_to_hexadecimal.cpp'
source_filename = "./others/decimal_to_hexadecimal.cpp"
...
@__const.main.HexValues = private unnamed_addr constant [17 x i8] c"0123456789ABCDEF\00", align 16
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [22 x i8] c"Enter a Decimal Value\00", align 1
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@.str.1 = private unnamed_addr constant [12 x i8] c"Hex Value: \00", align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_decimal_to_hexadecimal.cpp, ptr null }]
...
define dso_local noundef i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %5, ptr align 16 @__const.main.HexValues, i64 17, i1 false)
...
21:                                               ; preds = %9
  ...
  %25 = getelementptr inbounds [8 x i32], ptr %3, i64 0, i64 %24
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_decimal_to_hexadecimal.cpp() #0 section ".text.startup" {
