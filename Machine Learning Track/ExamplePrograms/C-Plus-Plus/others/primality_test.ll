; ModuleID = './others/primality_test.cpp'
source_filename = "./others/primality_test.cpp"
...
@.str = private unnamed_addr constant [40 x i8] c"Enter the value of n to check if Prime\0A\00", align 1
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@.str.1 = private unnamed_addr constant [10 x i8] c" is Prime\00", align 1
@.str.2 = private unnamed_addr constant [14 x i8] c" is not Prime\00", align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_primality_test.cpp, ptr null }]
...
define dso_local noundef zeroext i1 @_Z7IsPrimei(i32 noundef %0) #4 {
  %2 = alloca i1, align 1
...
define dso_local noundef i32 @main() #5 {
  ...
  %6 = call noundef zeroext i1 @_Z7IsPrimei(i32 noundef %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_primality_test.cpp() #0 section ".text.startup" {
