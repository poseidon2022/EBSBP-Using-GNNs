; ModuleID = './binomial_dist.cpp'
source_filename = "./binomial_dist.cpp"
...
define dso_local noundef double @_Z17binomial_expecteddd(double noundef %0, double noundef %1) #4 !prof !35 {
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local noundef double @_Z17binomial_variancedd(double noundef %0, double noundef %1) #4 !prof !36 {
  %3 = alloca double, align 8
  %4 = alloca double, align 8
  store double %0, ptr %3, align 8
  store double %1, ptr %4, align 8
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local noundef double @_Z27binomial_standard_deviationdd(double noundef %0, double noundef %1) #4 !prof !35 {
  %3 = alloca double, align 8
  %4 = alloca double, align 8
  store double %0, ptr %3, align 8
  store double %1, ptr %4, align 8
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local noundef double @_Z3nCrdd(double noundef %0, double noundef %1) #4 !prof !37 {
  %3 = alloca double, align 8
  %4 = alloca double, align 8
...
14:                                               ; preds = %27, %2
  ...
  br i1 %21, label %22, label %30, !prof !38
...
31:                                               ; preds = %41, %30
  ...
  br i1 %35, label %36, label %44, !prof !38
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local noundef double @_Z20binomial_x_successesddd(double noundef %0, double noundef %1, double noundef %2) #4 !prof !35 {
  %4 = alloca double, align 8
  %5 = alloca double, align 8
  %6 = alloca double, align 8
...
define dso_local noundef double @_Z24binomial_range_successesdddd(double noundef %0, double noundef %1, double noundef %2, double noundef %3) #5 !prof !35 {
  %5 = alloca double, align 8
  %6 = alloca double, align 8
...
13:                                               ; preds = %36, %4
  ...
  br i1 %17, label %18, label %39, !prof !42
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define linkonce_odr dso_local noundef double @_ZSt3powIdiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(double noundef %0, i32 noundef %1) #4 comdat !prof !44 {
  %3 = alloca double, align 8
...
define dso_local noundef i32 @main() #7 !prof !35 {
...
!3 = !{!"TotalCount", i64 8242}
!4 = !{!"MaxCount", i64 4033}
!5 = !{!"MaxInternalCount", i64 4033}
!6 = !{!"MaxFunctionCount", i64 57}
!7 = !{!"NumCounts", i64 11}
...
!13 = !{i32 10000, i64 4033, i32 2}
!14 = !{i32 100000, i64 4033, i32 2}
!15 = !{i32 200000, i64 4033, i32 2}
!16 = !{i32 300000, i64 4033, i32 2}
!17 = !{i32 400000, i64 4033, i32 2}
!18 = !{i32 500000, i64 4033, i32 2}
!19 = !{i32 600000, i64 4033, i32 2}
!20 = !{i32 700000, i64 4033, i32 2}
!21 = !{i32 800000, i64 4033, i32 2}
!22 = !{i32 900000, i64 4033, i32 2}
!23 = !{i32 950000, i64 4033, i32 2}
!24 = !{i32 990000, i64 56, i32 5}
!25 = !{i32 999000, i64 56, i32 5}
...
!37 = !{!"function_entry_count", i64 57}
!38 = !{!"branch_weights", i32 4034, i32 58}
!39 = distinct !{!39, !40}
!40 = !{!"llvm.loop.mustprogress"}
!41 = distinct !{!41, !40}
!42 = !{!"branch_weights", i32 57, i32 2}
!43 = distinct !{!43, !40}
!44 = !{!"function_entry_count", i64 56}
