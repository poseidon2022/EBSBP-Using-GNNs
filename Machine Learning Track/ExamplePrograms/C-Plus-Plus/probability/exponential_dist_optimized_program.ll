; ModuleID = './exponential_dist.cpp'
source_filename = "./exponential_dist.cpp"
...
@.str.3 = private unnamed_addr constant [23 x i8] c"./exponential_dist.cpp\00", align 1
...
define dso_local noundef double @_ZN11probability14geometric_dist20exponential_expectedEd(double noundef %0) #4 personality ptr @__gxx_personality_v0 !prof !35 {
...
; Function Attrs: mustprogress noinline optnone uwtable
define dso_local noundef double @_ZN11probability14geometric_dist15exponential_varEd(double noundef %0) #4 personality ptr @__gxx_personality_v0 !prof !37 {
  %2 = alloca double, align 8
  %3 = alloca ptr, align 8
  %4 = alloca i32, align 4
  store double %0, ptr %2, align 8
  %5 = load double, ptr %2, align 8
  %6 = fcmp ole double %5, 0.000000e+00
  br i1 %6, label %7, label %14, !prof !38
...
; Function Attrs: mustprogress noinline optnone uwtable
define dso_local noundef double @_ZN11probability14geometric_dist15exponential_stdEd(double noundef %0) #4 personality ptr @__gxx_personality_v0 !prof !37 {
  %2 = alloca double, align 8
  %3 = alloca ptr, align 8
  %4 = alloca i32, align 4
  store double %0, ptr %2, align 8
...
; Function Attrs: mustprogress noinline optnone uwtable
define internal void @_ZL4testv() #4 personality ptr @__gxx_personality_v0 !prof !39 !PGOFuncName !40 {
...
44:                                               ; preds = %43, %41
  ...
  br i1 %50, label %51, label %52, !prof !41
...
54:                                               ; preds = %53, %51
  ...
  br i1 %62, label %63, label %64, !prof !41
...
66:                                               ; preds = %65, %63
  ...
  br i1 %72, label %73, label %74, !prof !41
...
76:                                               ; preds = %75, %73
  ...
  br i1 %82, label %83, label %84, !prof !41
...
86:                                               ; preds = %85, %83
  ...
  br i1 %94, label %95, label %96, !prof !41
...
98:                                               ; preds = %97, %95
  ...
  br i1 %104, label %105, label %106, !prof !41
...
108:                                              ; preds = %107, %105
  ...
  br i1 %114, label %115, label %116, !prof !41
...
148:                                              ; preds = %146
  br i1 %147, label %149, label %150, !prof !41
...
193:                                              ; preds = %191
  br i1 %192, label %194, label %195, !prof !41
...
define linkonce_odr dso_local noundef double @_ZSt3absd(double noundef %0) #6 comdat !prof !42 {
  %2 = alloca double, align 8
  store double %0, ptr %2, align 8
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define linkonce_odr dso_local noundef zeroext i1 @_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef %1) #6 comdat !prof !43 {
  %3 = alloca ptr, align 8
...
!14 = !{i32 100000, i64 9, i32 1}
!15 = !{i32 200000, i64 9, i32 1}
!16 = !{i32 300000, i64 9, i32 1}
!17 = !{i32 400000, i64 5, i32 2}
!18 = !{i32 500000, i64 5, i32 2}
!19 = !{i32 600000, i64 3, i32 4}
!20 = !{i32 700000, i64 3, i32 4}
!21 = !{i32 800000, i64 3, i32 4}
!22 = !{i32 900000, i64 2, i32 6}
!23 = !{i32 950000, i64 2, i32 6}
!24 = !{i32 990000, i64 2, i32 6}
!25 = !{i32 999000, i64 2, i32 6}
!26 = !{i32 999900, i64 2, i32 6}
!27 = !{i32 999990, i64 2, i32 6}
!28 = !{i32 999999, i64 2, i32 6}
...
!36 = !{!"branch_weights", i32 3, i32 4}
!37 = !{!"function_entry_count", i64 3}
!38 = !{!"branch_weights", i32 1, i32 4}
!39 = !{!"function_entry_count", i64 1}
!40 = !{!"exponential_dist.cpp:_ZL4testv"}
