; ModuleID = './probability/bayes_theorem.cpp'
source_filename = "./probability/bayes_theorem.cpp"
...
@.str = private unnamed_addr constant [13 x i8] c"A given B = \00", align 1
@.str.1 = private unnamed_addr constant [13 x i8] c"B given A = \00", align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_bayes_theorem.cpp, ptr null }]
...
define dso_local noundef double @_Z13bayes_AgivenBddd(double noundef %0, double noundef %1, double noundef %2) #4 {
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local noundef double @_Z13bayes_BgivenAddd(double noundef %0, double noundef %1, double noundef %2) #4 {
  %4 = alloca double, align 8
  %5 = alloca double, align 8
  %6 = alloca double, align 8
  store double %0, ptr %4, align 8
...
define dso_local noundef i32 @main() #5 {
  ...
  store double 9.000000e-01, ptr %4, align 8
  %6 = load double, ptr %4, align 8
  %7 = load double, ptr %2, align 8
  %8 = load double, ptr %3, align 8
  %9 = call noundef double @_Z13bayes_AgivenBddd(double noundef %6, double noundef %7, double noundef %8)
  ...
  %18 = call noundef double @_Z13bayes_BgivenAddd(double noundef %15, double noundef %16, double noundef %17)
  %19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEd(ptr noundef nonnull align 8 dereferenceable(8) %14, double noundef %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_bayes_theorem.cpp() #0 section ".text.startup" {
