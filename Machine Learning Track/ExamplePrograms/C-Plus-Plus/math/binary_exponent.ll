; ModuleID = './math/binary_exponent.cpp'
source_filename = "./math/binary_exponent.cpp"
...
@.str = private unnamed_addr constant [11 x i8] c"Math error\00", align 1
@.str.1 = private unnamed_addr constant [29 x i8] c"Exponent must be positive !!\00", align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_binary_exponent.cpp, ptr null }]
...
define dso_local noundef i32 @_Z7binExpoii(i32 noundef %0, i32 noundef %1) #4 {
...
10:                                               ; preds = %2
  ...
  %13 = sdiv i32 %12, 2
  %14 = call noundef i32 @_Z7binExpoii(i32 noundef %11, i32 noundef %13)
...
define dso_local noundef i32 @_Z11binExpo_altii(i32 noundef %0, i32 noundef %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
21:                                               ; preds = %15
  ...
  %24 = call noundef i32 @_Z7binExpoii(i32 noundef %22, i32 noundef %23)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_binary_exponent.cpp() #0 section ".text.startup" {
