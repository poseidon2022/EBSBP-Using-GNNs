; ModuleID = './iterative_factorial.cpp'
source_filename = "./iterative_factorial.cpp"
...
@.str.3 = private unnamed_addr constant [26 x i8] c"./iterative_factorial.cpp\00", align 1
...
define dso_local noundef i64 @_ZN4math18iterativeFactorialEh(i8 noundef zeroext %0) #4 personality ptr @__gxx_personality_v0 !prof !35 {
  %2 = alloca i8, align 1
  ...
  %7 = zext i8 %6 to i32
  %8 = icmp sgt i32 %7, 20
  br i1 %8, label %9, label %16, !prof !36
...
17:                                               ; preds = %21, %16
  ...
  br i1 %20, label %21, label %28, !prof !37
...
define dso_local noundef i32 @main() #5 !prof !40 {
...
; Function Attrs: mustprogress noinline optnone uwtable
define internal void @_ZL4testv() #4 personality ptr @__gxx_personality_v0 !prof !40 !PGOFuncName !41 {
  %1 = alloca i8, align 1
  ...
  %7 = icmp eq i64 %6, 1
  br i1 %7, label %8, label %9, !prof !42
...
11:                                               ; preds = %10, %8
  ...
  %14 = icmp eq i64 %13, 1
  br i1 %14, label %15, label %16, !prof !42
...
54:                                               ; preds = %51, %42
  ...
  br i1 %56, label %57, label %58, !prof !42
...
!14 = !{i32 100000, i64 32, i32 1}
!15 = !{i32 200000, i64 32, i32 1}
!16 = !{i32 300000, i64 32, i32 1}
!17 = !{i32 400000, i64 32, i32 1}
!18 = !{i32 500000, i64 32, i32 1}
!19 = !{i32 600000, i64 32, i32 1}
!20 = !{i32 700000, i64 6, i32 2}
...
!36 = !{!"branch_weights", i32 2, i32 6}
!37 = !{!"branch_weights", i32 33, i32 6}
!38 = distinct !{!38, !39}
!39 = !{!"llvm.loop.mustprogress"}
!40 = !{!"function_entry_count", i64 1}
!41 = !{!"iterative_factorial.cpp:_ZL4testv"}
