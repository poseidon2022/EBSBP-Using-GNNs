; ModuleID = './test/corners.cpp'
source_filename = "./test/corners.cpp"
...
@_ZL20test_handler_corners = internal global %"class.Eigen::EigenTest" zeroinitializer, align 8
@.str.35 = private unnamed_addr constant [8 x i8] c"corners\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_corners.cpp, ptr null }]
...
define internal void @__cxx_global_var_init.34() #0 section ".text.startup" {
  call void @_ZN5Eigen9EigenTestC2EPKcPFvvE(ptr noundef nonnull align 8 dereferenceable(40) @_ZL20test_handler_corners, ptr noundef @.str.35, ptr noundef @_Z12test_cornersv)
  %1 = call i32 @__cxa_atexit(ptr @_ZN5Eigen9EigenTestD2Ev, ptr @_ZL20test_handler_corners, ptr @__dso_handle) #3
  ret void
}

; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local void @_Z12test_cornersv() #8 !prof !35 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_corners.cpp() #0 section ".text.startup" {
