; ModuleID = './test/umeyama.cpp'
source_filename = "./test/umeyama.cpp"
...
@_ZL20test_handler_umeyama = internal global %"class.Eigen::EigenTest" zeroinitializer, align 8
@.str.35 = private unnamed_addr constant [8 x i8] c"umeyama\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_umeyama.cpp, ptr null }]
...
define internal void @__cxx_global_var_init.34() #0 section ".text.startup" {
  call void @_ZN5Eigen9EigenTestC2EPKcPFvvE(ptr noundef nonnull align 8 dereferenceable(40) @_ZL20test_handler_umeyama, ptr noundef @.str.35, ptr noundef @_Z12test_umeyamav)
  %1 = call i32 @__cxa_atexit(ptr @_ZN5Eigen9EigenTestD2Ev, ptr @_ZL20test_handler_umeyama, ptr @__dso_handle) #3
  ret void
}

; Function Attrs: mustprogress noinline optnone uwtable
define dso_local void @_Z12test_umeyamav() #5 !prof !35 {
...
6:                                                ; preds = %20, %0
  ...
  %9 = icmp slt i32 %7, %8
  br i1 %9, label %10, label %23, !prof !46

10:                                               ; preds = %6
  store i32 40, ptr %3, align 4
  store i32 500, ptr %4, align 4
  %11 = call noundef i32 @_ZN5Eigen8internal6randomIiEENS0_13random_retvalINS0_36global_math_functions_filtering_baseIT_vE4typeEE4typeERKS4_SA_(ptr noundef nonnull align 4 dereferenceable(4) %3, ptr noundef nonnull align 4 dereferenceable(4) %4)
...
define linkonce_odr dso_local noundef i32 @_ZN5Eigen8internal16random_bits_implIjE3runEi(i32 noundef %0) #5 comdat align 2 personality ptr @__gxx_personality_v0 !prof !68 {
  ...
  %10 = icmp sge i32 %9, 0
  br i1 %10, label %11, label %14, !prof !69

11:                                               ; preds = %1
  %12 = load i32, ptr %2, align 4
  %13 = icmp sle i32 %12, 32
  br i1 %13, label %40, label %14, !prof !69
...
45:                                               ; preds = %56, %40
  ...
  br i1 %48, label %49, label %59, !prof !70
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_umeyama.cpp() #0 section ".text.startup" {
...
!14 = !{i32 100000, i64 60, i32 1}
!15 = !{i32 200000, i64 11, i32 8}
!16 = !{i32 300000, i64 11, i32 8}
!17 = !{i32 400000, i64 10, i32 17}
!18 = !{i32 500000, i64 10, i32 17}
!19 = !{i32 600000, i64 6, i32 24}
!20 = !{i32 700000, i64 4, i32 37}
!21 = !{i32 800000, i64 2, i32 66}
!22 = !{i32 900000, i64 1, i32 119}
!23 = !{i32 950000, i64 1, i32 119}
!24 = !{i32 990000, i64 1, i32 119}
!25 = !{i32 999000, i64 1, i32 119}
!26 = !{i32 999900, i64 1, i32 119}
!27 = !{i32 999990, i64 1, i32 119}
!28 = !{i32 999999, i64 1, i32 119}
...
!47 = !{!"branch_weights", i32 61, i32 11}
!48 = distinct !{!48, !39}
!49 = distinct !{!49, !39}
...
!66 = !{!"branch_weights", i32 2, i32 11}
!67 = distinct !{!67, !39}
!68 = !{!"function_entry_count", i64 11}
!69 = !{!"branch_weights", i32 12, i32 1}
!70 = !{!"branch_weights", i32 12, i32 12}
!71 = distinct !{!71, !39}
