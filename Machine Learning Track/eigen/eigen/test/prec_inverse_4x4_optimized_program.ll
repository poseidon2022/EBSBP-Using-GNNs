; ModuleID = './test/prec_inverse_4x4.cpp'
source_filename = "./test/prec_inverse_4x4.cpp"
...
@_ZL29test_handler_prec_inverse_4x4 = internal global %"class.Eigen::EigenTest" zeroinitializer, align 8
@.str.35 = private unnamed_addr constant [17 x i8] c"prec_inverse_4x4\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_prec_inverse_4x4.cpp, ptr null }]
...
define internal void @__cxx_global_var_init.34() #0 section ".text.startup" {
  call void @_ZN5Eigen9EigenTestC2EPKcPFvvE(ptr noundef nonnull align 8 dereferenceable(40) @_ZL29test_handler_prec_inverse_4x4, ptr noundef @.str.35, ptr noundef @_Z21test_prec_inverse_4x4v)
  %1 = call i32 @__cxa_atexit(ptr @_ZN5Eigen9EigenTestD2Ev, ptr @_ZL29test_handler_prec_inverse_4x4, ptr @__dso_handle) #3
  ret void
}

; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local void @_Z21test_prec_inverse_4x4v() #8 !prof !35 {
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_prec_inverse_4x4.cpp() #0 section ".text.startup" {
