; ModuleID = './test/special_numbers.cpp'
source_filename = "./test/special_numbers.cpp"
...
@_ZL28test_handler_special_numbers = internal global %"class.Eigen::EigenTest" zeroinitializer, align 8
@.str.35 = private unnamed_addr constant [16 x i8] c"special_numbers\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_special_numbers.cpp, ptr null }]
...
define internal void @__cxx_global_var_init.34() #0 section ".text.startup" {
  call void @_ZN5Eigen9EigenTestC2EPKcPFvvE(ptr noundef nonnull align 8 dereferenceable(40) @_ZL28test_handler_special_numbers, ptr noundef @.str.35, ptr noundef @_Z20test_special_numbersv)
  %1 = call i32 @__cxa_atexit(ptr @_ZN5Eigen9EigenTestD2Ev, ptr @_ZL28test_handler_special_numbers, ptr @__dso_handle) #3
  ret void
}

; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local void @_Z20test_special_numbersv() #8 !prof !35 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_special_numbers.cpp() #0 section ".text.startup" {
...
!17 = !{i32 400000, i64 7, i32 5}
!18 = !{i32 500000, i64 5, i32 10}
!19 = !{i32 600000, i64 4, i32 22}
!20 = !{i32 700000, i64 2, i32 51}
!21 = !{i32 800000, i64 2, i32 51}
...
!46 = !{!"branch_weights", i32 101, i32 2}
!47 = distinct !{!47, !39}
