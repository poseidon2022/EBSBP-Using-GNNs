; ModuleID = './test/packetmath.cpp'
source_filename = "./test/packetmath.cpp"
...
@g_first_pass = dso_local global i8 1, align 1
@_ZL23test_handler_packetmath = internal global %"class.Eigen::EigenTest" zeroinitializer, align 8
@.str.35 = private unnamed_addr constant [11 x i8] c"packetmath\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_packetmath.cpp, ptr null }]
...
define internal void @__cxx_global_var_init.34() #0 section ".text.startup" {
  call void @_ZN5Eigen9EigenTestC2EPKcPFvvE(ptr noundef nonnull align 8 dereferenceable(40) @_ZL23test_handler_packetmath, ptr noundef @.str.35, ptr noundef @_Z15test_packetmathv)
  %1 = call i32 @__cxa_atexit(ptr @_ZN5Eigen9EigenTestD2Ev, ptr @_ZL23test_handler_packetmath, ptr @__dso_handle) #3
  ret void
}

; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local void @_Z15test_packetmathv() #8 !prof !35 {
  %1 = alloca i32, align 4
  store i8 1, ptr @g_first_pass, align 1
...
6:                                                ; preds = %2
  store i8 0, ptr @g_first_pass, align 1
  br label %7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_packetmath.cpp() #0 section ".text.startup" {
