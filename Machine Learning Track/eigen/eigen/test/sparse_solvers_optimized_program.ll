; ModuleID = './test/sparse_solvers.cpp'
source_filename = "./test/sparse_solvers.cpp"
...
@_ZL27test_handler_sparse_solvers = internal global %"class.Eigen::EigenTest" zeroinitializer, align 8
@.str.35 = private unnamed_addr constant [15 x i8] c"sparse_solvers\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_sparse_solvers.cpp, ptr null }]
...
define internal void @__cxx_global_var_init.34() #0 section ".text.startup" {
  call void @_ZN5Eigen9EigenTestC2EPKcPFvvE(ptr noundef nonnull align 8 dereferenceable(40) @_ZL27test_handler_sparse_solvers, ptr noundef @.str.35, ptr noundef @_Z19test_sparse_solversv)
  %1 = call i32 @__cxa_atexit(ptr @_ZN5Eigen9EigenTestD2Ev, ptr @_ZL27test_handler_sparse_solvers, ptr @__dso_handle) #3
  ret void
}

; Function Attrs: mustprogress noinline optnone uwtable
define dso_local void @_Z19test_sparse_solversv() #5 !prof !35 {
...
5:                                                ; preds = %11, %0
  ...
  %8 = icmp slt i32 %6, %7
  br i1 %8, label %9, label %14, !prof !46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_sparse_solvers.cpp() #0 section ".text.startup" {
...
!15 = !{i32 200000, i64 13, i32 6}
!16 = !{i32 300000, i64 10, i32 16}
!17 = !{i32 400000, i64 10, i32 16}
!18 = !{i32 500000, i64 7, i32 19}
!19 = !{i32 600000, i64 4, i32 36}
!20 = !{i32 700000, i64 4, i32 36}
!21 = !{i32 800000, i64 2, i32 65}
...
!63 = !{!"branch_weights", i32 1, i32 11}
!64 = !{!"branch_weights", i32 4, i32 11}
!65 = distinct !{!65, !39}
!66 = !{!"function_entry_count", i64 13}
!67 = !{!"branch_weights", i32 14, i32 1}
!68 = !{!"branch_weights", i32 14, i32 14}
!69 = distinct !{!69, !39}
