; ModuleID = './test/qr.cpp'
source_filename = "./test/qr.cpp"
...
@_ZL15test_handler_qr = internal global %"class.Eigen::EigenTest" zeroinitializer, align 8
@.str.35 = private unnamed_addr constant [3 x i8] c"qr\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_qr.cpp, ptr null }]
...
define internal void @__cxx_global_var_init.34() #0 section ".text.startup" {
  call void @_ZN5Eigen9EigenTestC2EPKcPFvvE(ptr noundef nonnull align 8 dereferenceable(40) @_ZL15test_handler_qr, ptr noundef @.str.35, ptr noundef @_Z7test_qrv)
  %1 = call i32 @__cxa_atexit(ptr @_ZN5Eigen9EigenTestD2Ev, ptr @_ZL15test_handler_qr, ptr @__dso_handle) #3
  ret void
}

; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local void @_Z7test_qrv() #8 !prof !35 {
...
12:                                               ; preds = %17, %11
  ...
  %14 = load i32, ptr @_ZN5EigenL8g_repeatE, align 4
  %15 = icmp slt i32 %13, %14
  br i1 %15, label %16, label %20, !prof !46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_qr.cpp() #0 section ".text.startup" {
