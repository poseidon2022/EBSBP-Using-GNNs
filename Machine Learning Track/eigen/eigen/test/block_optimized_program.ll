; ModuleID = './test/block.cpp'
source_filename = "./test/block.cpp"
...
@_ZL18test_handler_block = internal global %"class.Eigen::EigenTest" zeroinitializer, align 8
...
define internal void @__cxx_global_var_init.34() #0 section ".text.startup" {
  call void @_ZN5Eigen9EigenTestC2EPKcPFvvE(ptr noundef nonnull align 8 dereferenceable(40) @_ZL18test_handler_block, ptr noundef @.str.35, ptr noundef @_Z10test_blockv)
  %1 = call i32 @__cxa_atexit(ptr @_ZN5Eigen9EigenTestD2Ev, ptr @_ZL18test_handler_block, ptr @__dso_handle) #3
  ret void
}

; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local void @_Z10test_blockv() #8 !prof !35 {
