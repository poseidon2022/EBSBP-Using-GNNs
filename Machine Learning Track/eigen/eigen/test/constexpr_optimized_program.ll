; ModuleID = './test/constexpr.cpp'
source_filename = "./test/constexpr.cpp"
...
@_ZL22test_handler_constexpr = internal global %"class.Eigen::EigenTest" zeroinitializer, align 8
@.str.35 = private unnamed_addr constant [10 x i8] c"constexpr\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_constexpr.cpp, ptr null }]
...
define internal void @__cxx_global_var_init.34() #0 section ".text.startup" {
  call void @_ZN5Eigen9EigenTestC2EPKcPFvvE(ptr noundef nonnull align 8 dereferenceable(40) @_ZL22test_handler_constexpr, ptr noundef @.str.35, ptr noundef @_Z14test_constexprv)
  %1 = call i32 @__cxa_atexit(ptr @_ZN5Eigen9EigenTestD2Ev, ptr @_ZL22test_handler_constexpr, ptr @__dso_handle) #3
  ret void
}

; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local void @_Z14test_constexprv() #8 !prof !35 {
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_constexpr.cpp() #0 section ".text.startup" {
