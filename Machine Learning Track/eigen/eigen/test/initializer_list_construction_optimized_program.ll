; ModuleID = './test/initializer_list_construction.cpp'
source_filename = "./test/initializer_list_construction.cpp"
...
@_ZL42test_handler_initializer_list_construction = internal global %"class.Eigen::EigenTest" zeroinitializer, align 8
@.str.35 = private unnamed_addr constant [30 x i8] c"initializer_list_construction\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_initializer_list_construction.cpp, ptr null }]
...
define internal void @__cxx_global_var_init.34() #0 section ".text.startup" {
  call void @_ZN5Eigen9EigenTestC2EPKcPFvvE(ptr noundef nonnull align 8 dereferenceable(40) @_ZL42test_handler_initializer_list_construction, ptr noundef @.str.35, ptr noundef @_Z34test_initializer_list_constructionv)
  %1 = call i32 @__cxa_atexit(ptr @_ZN5Eigen9EigenTestD2Ev, ptr @_ZL42test_handler_initializer_list_construction, ptr @__dso_handle) #3
  ret void
}

; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local void @_Z34test_initializer_list_constructionv() #8 !prof !35 {
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_initializer_list_construction.cpp() #0 section ".text.startup" {
