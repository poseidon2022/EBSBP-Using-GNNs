; ModuleID = './test/geo_transformations.cpp'
source_filename = "./test/geo_transformations.cpp"
...
@_ZL32test_handler_geo_transformations = internal global %"class.Eigen::EigenTest" zeroinitializer, align 8
@.str.35 = private unnamed_addr constant [20 x i8] c"geo_transformations\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_geo_transformations.cpp, ptr null }]
...
define internal void @__cxx_global_var_init.34() #0 section ".text.startup" {
  call void @_ZN5Eigen9EigenTestC2EPKcPFvvE(ptr noundef nonnull align 8 dereferenceable(40) @_ZL32test_handler_geo_transformations, ptr noundef @.str.35, ptr noundef @_Z24test_geo_transformationsv)
  %1 = call i32 @__cxa_atexit(ptr @_ZN5Eigen9EigenTestD2Ev, ptr @_ZL32test_handler_geo_transformations, ptr @__dso_handle) #3
  ret void
}

; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local void @_Z24test_geo_transformationsv() #8 !prof !35 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_geo_transformations.cpp() #0 section ".text.startup" {
